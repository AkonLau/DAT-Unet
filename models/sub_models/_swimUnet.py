...
class SwinTransformerSys(nn.Module):
    ...
    Args:
        ...
        in_chans (int): Number of input image channels. Default: 3
        out_channels (int): Number of channels for output head. Default: 1
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, out_chans=1,
        ...
        print("SwinTransformerSys expand initial----depths:{};depths_decoder:{};drop_path_rate:{};out_channels:{}".format(depths,
        ...
        if self.final_upsample == "expand_first":
            ...
            self.output = nn.Conv2d(in_channels=embed_dim,out_channels=self.out_channels,kernel_size=1,bias=False)
    ...
    def flops(self):
        ...
        flops += self.num_features * self.out_channels
        return flops
